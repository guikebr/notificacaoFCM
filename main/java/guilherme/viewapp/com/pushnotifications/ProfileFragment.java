    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        mFirestore.collection("Users").document(mUserId).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                placeholderOptions.placeholder(R.mipmap.ic_camera_profile);
                Glide.with(container.getContext()).setDefaultRequestOptions(placeholderOptions).load(user_image).into(mProfileImage);
            ...
            public void onClick(View v) {
                ...
                mFirestore.collection("Users").document(mUserId).update(tokenMapRemove).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        mAuth.signOut();
                        Intent mainIntent = new Intent(container.getContext(), LoginActivity.class);
