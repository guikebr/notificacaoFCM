...
public class SendActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_id_view.setText(mUserName);

        user_id_view.setText("Enviando messagem para "+ mUserName);
                ...
                if(!TextUtils.isEmpty(message)){
                    ...
                    mFirestore.collection("Users/"+mUserId+"/Notifications").add(notificationMessage).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            ...
                            Toast.makeText(SendActivity.this, "Mensagem enviada.",
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(SendActivity.this, "Erro: " + e.getMessage(),
                                    Toast.LENGTH_LONG).show();
                            mMessageProgress.setVisibility(View.INVISIBLE);
                        }
                    });
