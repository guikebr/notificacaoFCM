...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameField = (EditText) findViewById(R.id.register_name_btn);
        mEmailField = (EditText) findViewById(R.id.register_email_btn);
        mPasswordField = (EditText) findViewById(R.id.register_password_btn);
            ...
            public void onClick(View v) {
                ...
                if (imageUri != null){
                    ...
                    if (!TextUtils.isEmpty(name) && !TextUtils.isEmpty(email) && !TextUtils.isEmpty(password)){
                        ...
                        mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()){
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        sendToMain();
                                                            ...
                                                            public void onFailure(@NonNull Exception e) {
                                                                Toast.makeText(RegisterActivity.this, "Erro: "+e.getMessage(),
                                                                        Toast.LENGTH_LONG).show();
                                                    }
                                                });

                                            }else {
                                                Toast.makeText(RegisterActivity.this, "Erro: "+uploadtask.getException().getMessage(),
                                                        Toast.LENGTH_LONG).show();
                                                mRegisterProgressBar.setVisibility(View.INVISIBLE);
                                            }
                                        }
                                    ...
                                    Toast.makeText(RegisterActivity.this, "Erro: "+task.getException().getMessage(),
                                            Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(RegisterActivity.this, "Preencha todos os campos.",
                                Toast.LENGTH_LONG).show();
                    }
                }
            }
        ...
        mImageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(Intent.createChooser(intent, "Seleciona a imagem"),
                        PICK_IMAGE);
            }
        });
    }
